...
const Button = ({
  ...
  const contents = (
    <>
      {iconBefore ? (
        <Icon name={iconBefore} className="button__icon button__icon--before" />
      ) : null}
      {icon ? (
        <Icon name={icon} className="button__icon button__icon--center" />
      ) : (
        children
      )}
      {iconAfter ? (
        <Icon name={iconAfter} className="button__icon button__icon--after" />
      ) : null}
    </>
  );
